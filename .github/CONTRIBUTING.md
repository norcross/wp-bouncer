# Contribute to WP Bouncer

Contributions of all kinds are appreciated. When contributing, please follow these guidelines to ensure things work as smoothly as possible.

__Please Note:__ GitHub is for bug reports and contributions only. If you have a support or customization question, go to our [Contact Page](https://www.strangerstudios.com/contact/) instead.
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/wp-bouncer/issues/new/choose)
...
* For bug fixes, checkout the DEV branch of the repository.
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/wp-bouncer.git` to set the upstream repo
...
* Ensure you stick to the [WordPress Coding Standards](https://codex.wordpress.org/WordPress_Coding_Standards) (even though much of the code does not currently)
...
* For bug fixes, submit a pull request to the DEV branch of the repository.
...
* An example of [how we use phpDoc blocks can be found here](https://gist.github.com/sunnyratilal/5308969).
